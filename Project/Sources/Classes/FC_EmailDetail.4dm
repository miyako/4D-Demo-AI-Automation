...
Function _renderQuoteResult($result : Object)
	...
	If ($result.validation#Null) && ($result.validation.success)
		OBJECT SET TITLE(*; "text_ai_validation_badge"; "✅ JSON Validate: "+$result.validation.schemaName+" OK")
	Else 
		OBJECT SET TITLE(*; "text_ai_validation_badge"; "❌ JSON Validate: schema_quote_combined failed")
	End if 
...
Function _renderModificationResult($result : Object)
	...
	If ($result.validation#Null) && ($result.validation.success)
		OBJECT SET TITLE(*; "text_ai_validation_badge"; "✅ JSON Validate: "+$result.validation.schemaName+" OK")
	Else 
		OBJECT SET TITLE(*; "text_ai_validation_badge"; "❌ JSON Validate: schema_modification_impacts failed")
	End if 
